...
const FloatingDockCore = () => {
  const links: Link[] = [
    {
      title: 'Home',
      icon: <HomeIcon className="h-full w-full text-neutral-900" />,
      href: '/',
    },
    {
      title: 'Projects',
      icon: <TerminalIcon className="h-full w-full text-neutral-900" />,
      href: '/projects',
    },
    {
      title: 'Github',
      icon: <Github className="h-full w-full text-neutral-900" />,
      href: 'https://github.com/hrushikesh44',
    },
    {
      title: 'twitter',
      icon: <Twitter className="h-full w-full text-neutral-900" />,
      href: 'https://x.com/hrushikesh_44',
    },
    {
      title: 'Mail',
      icon: <Mail className="h-full w-full text-neutral-900" />,
  ...
  return (
    <motion.div
      ...
      className="flex justify-center items-center fixed bottom-10 inset-x-0 mx-auto h-16 border border-neutral-100/40 w-fit p-5 gap-5 rounded-full bg-gradient-to-r from-neutral-600 via-neutral-300 to bg-neutral-600"
    >
      {links.map((el, idX) => (
        <IconContainer
          key={el.title}
  ...
  return (
    <Link href={el.href}>
      <motion.div
        ...
        className=" flex items-center justify-center rounded-2xl bg-neutral-600 "
      >
        <motion.div
          style={{
